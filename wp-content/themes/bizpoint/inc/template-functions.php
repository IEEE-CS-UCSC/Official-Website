...
function bizpoint_is_default_frontpage() {
	if( get_option( 'show_on_front' ) === 'page' ) {
		...
		if( ( $current_frontpage_template === 'page-templates/full-width.php' ) || ( $current_frontpage_template === 'page-templates/no-sidebar.php' ) ) {
			return false;
		}
		else {
			return true;
...
function bizpoint_is_frontpage_inactive() {
	return !bizpoint_is_default_frontpage();
}
